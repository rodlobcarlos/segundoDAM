...
public class Mascota implements Runnable {
	...
	public void comer() {
		...
		System.out.println("La macota " + getNombre() + " ha comenzado a comer." + Thread.currentThread().getName() + " " + Thread.currentThread().getPriority());
		try {
			Thread.sleep(1000*this.alimentado);
			// Pinta el nombre de la mascota y del cuidador
			System.out.println("La mascota " + getNombre() + " ha terminado de comer."  + Thread.currentThread().getName() + " " + Thread.currentThread().getPriority());
